...
example_prompts_C = ['Hi, my name is ' + name + '. Answer:' for name in D_name_f]

target_text_C = [" " + name for name in D_name_f]
...
example_prompts_D = ['Hi, my name is ' + name + '. Answer:' for name in D_name_m]

target_text_D = [' ' + name for name in D_name_m]
